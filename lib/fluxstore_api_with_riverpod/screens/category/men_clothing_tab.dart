...
class MenClothTabs extends ConsumerStatefulWidget {
  final ScrollController controller;
  final String? categori;
  const MenClothTabs({super.key, required this.controller, this.categori});

  @override
  ConsumerState<MenClothTabs> createState() => _ElectronicTabsState();
}

class _ElectronicTabsState extends ConsumerState<MenClothTabs> {
  @override

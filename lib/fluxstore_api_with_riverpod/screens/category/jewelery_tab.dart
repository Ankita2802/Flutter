...
class JeweleryTabs extends ConsumerStatefulWidget {
  final ScrollController controller;
  final String? categori;
  const JeweleryTabs({super.key, required this.controller, this.categori});

  @override
  ConsumerState<JeweleryTabs> createState() => _ElectronicTabsState();
}

class _ElectronicTabsState extends ConsumerState<JeweleryTabs> {
  @override

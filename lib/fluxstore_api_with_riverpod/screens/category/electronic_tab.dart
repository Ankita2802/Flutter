...
class ElectronicTabs extends ConsumerStatefulWidget {
  final ScrollController controller;
  final String? categori;
  const ElectronicTabs({super.key, required this.controller, this.categori});

  @override
  ConsumerState<ElectronicTabs> createState() => _ElectronicTabsState();
}

class _ElectronicTabsState extends ConsumerState<ElectronicTabs> {
  @override
